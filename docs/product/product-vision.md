...
The **ARES app** hosts your **Companion**: software between one person and a
complicated digital world — Mac product on device, light WebUI off device,
unified journal and technical control so every worker stops living in a silo.
It is not the droid’s personal name and not merely a chatbot.
