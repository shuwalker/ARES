"""Grok Reverse API Web Scraper Scaffolding."""
...
class GrokWebBackend(ReverseAPIBase):
    name = "grok-web"

    def get_backend_name(self) -> str:
        return "Grok (Web Automation)"

    def run_turn(self, message: str, session_id: str, **kwargs) -> Dict[str, Any]:
        """
        Executes a turn on x.com/i/grok using safari-mcp.

        LOCAL AI TODO:
        1. Initialize `self._get_safari_mcp_client()`.
        2. Use `safari_navigate` to go to https://x.com/i/grok.
        ...
        """
        raise NotImplementedError("Local AI must implement Grok scraping logic using safari-mcp.")
