...
- **Dependency Isolation**: Do not import `services/controller/` or `apps/macos/` internal components into this folder. Keep dependencies strictly local to each tool.
