...
If your change affects browser behavior, also run the relevant manual checks
from [the WebUI testing guide](../.claude/webui/TESTING.md).
...
- [WebUI architecture](../.claude/webui/ARCHITECTURE.md) for implementation
  details and design constraints
- [WebUI testing](../.claude/webui/TESTING.md) for manual and automated
...
- [README.md](README.md)
- [WebUI architecture](../.claude/webui/ARCHITECTURE.md)
- [WebUI testing](../.claude/webui/TESTING.md)
