...
import { activityLog, agents, domains, createDb, executionWorkspaces, goals, issues, projects, projectWorkspaces, type Db } from "@paperclipai/db";
...
describeEmbeddedPostgres("workspace file resources", () => {
  ...
  it("reads explicit cross-project git_repo workspaces with a local checkout", async () => {
    ...
    const readmePath = "content-os/life_admin/active/2026-06-06-pap-10199-bundled-skills/README.md";
