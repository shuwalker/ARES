...
describe("GET /invites/:token/logo", () => {
  ...
  it("serves the company logo for an active invite without company auth", async () => {
    ...
    expect(mockStorage.headObject).toHaveBeenCalledWith("company-1", "assets/domains/logo-1");
    expect(mockStorage.getObject).toHaveBeenCalledWith("company-1", "assets/domains/logo-1");
  });
