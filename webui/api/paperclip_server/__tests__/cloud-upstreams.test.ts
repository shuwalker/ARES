...
import { domains, cloudUpstreamConnections, cloudUpstreamRuns, companySkills, createDb } from "@paperclipai/db";
...
describeEmbeddedPostgres("cloud upstream persistence", () => {
  ...
  async function seedDomain(companyId: string) {
