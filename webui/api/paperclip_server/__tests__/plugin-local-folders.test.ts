...
describe("plugin local folders", () => {
  ...
  it("creates missing nested parent directories for atomic writes", async () => {
    ...
    await writePluginLocalFolderTextAtomic(root, "life_admin/active/smoke/README.md", "hello");

    await expect(readPluginLocalFolderText(root, "life_admin/active/smoke/README.md")).resolves.toBe("hello");
  });
