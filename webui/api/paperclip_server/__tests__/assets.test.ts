...
describe("POST /api/domains/:domainId/assets/images", () => {
  beforeEach(() => {
    vi.resetModules();
  ...
  it("accepts PNG image uploads and returns an asset path", async () => {
    ...
    const res = await requestApp(app, (baseUrl) =>
      request(baseUrl)
        .post("/api/domains/domain-1/assets/images")
  ...
  it("allows supported non-image attachments outside the domain logo flow", async () => {
...
describe("POST /api/domains/:domainId/logo", () => {
  beforeEach(() => {
    vi.resetModules();
    vi.doUnmock("../services/index.js");
    vi.doUnmock("../routes/assets.js");
  ...
  it("accepts PNG logo uploads and returns an asset path", async () => {
    ...
    const res = await requestApp(app, (baseUrl) =>
      request(baseUrl)
        .post("/api/domains/domain-1/logo")
        .attach("file", Buffer.from("png"), "logo.png"),
    );
