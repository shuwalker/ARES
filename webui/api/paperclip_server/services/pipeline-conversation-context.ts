...
export async function loadWorkflowConversationBodyDocumentContext(
  ...
  const commentsByThread = new Map<string, WorkflowConversationBodyDocumentContext["openAnnotationThreads"][number]["comments"]>();
...
export function formatWorkflowConversationBodyDocumentContextMarkdown(
  context: WorkflowConversationBodyDocumentContext | null,
) {
