 ...
 * the `domain_secrets` table. Operators place these UUIDs into plugin
...
export const PLUGIN_SECRET_REFS_DISABLED_MESSAGE =
  "Plugin secret references are disabled until domain-scoped plugin config lands";
...
export function createPluginSecretsHandler(
  ...
  return {
    async resolve(params: PluginSecretsResolveParams): Promise<string> {
      ...
      // explicit domain scope for secret bindings and resolution.
