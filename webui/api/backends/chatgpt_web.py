"""ChatGPT Reverse API Web Scraper Scaffolding."""
...
class ChatGPTWebBackend(ReverseAPIBase):
    name = "chatgpt-web"

    def get_backend_name(self) -> str:
        return "ChatGPT (Web Automation)"

    def run_turn(self, message: str, session_id: str, **kwargs) -> Dict[str, Any]:
        """
        Executes a turn on chatgpt.com using safari-mcp.

        LOCAL AI TODO:
        1. Initialize `self._get_safari_mcp_client()`.
        2. Use `safari_navigate` to go to https://chatgpt.com.
        ...
        """
        raise NotImplementedError("Local AI must implement ChatGPT scraping logic using safari-mcp.")
