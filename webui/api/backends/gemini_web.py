"""Gemini Reverse API Web Scraper Scaffolding."""
...
class GeminiWebBackend(ReverseAPIBase):
    name = "gemini-web"

    def get_backend_name(self) -> str:
        return "Gemini (Web Automation)"

    def run_turn(self, message: str, session_id: str, **kwargs) -> Dict[str, Any]:
        """
        Executes a turn on gemini.google.com using safari-mcp.

        LOCAL AI TODO:
        1. Initialize `self._get_safari_mcp_client()`.
        2. Use `safari_navigate` to go to https://gemini.google.com.
        ...
        """
        raise NotImplementedError("Local AI must implement Gemini scraping logic using safari-mcp.")
