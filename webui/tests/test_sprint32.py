...
class TestAutoInstallAgentDeps:
    ...
    All tests that exercise the install path set ARES_WEBUI_AUTO_INSTALL=1
    ...
    def test_disabled_by_default(self, tmp_path, capsys):
        ...
        env = {'ARES_WEBUI_AGENT_DIR': str(agent_dir)}
        with patch.dict('os.environ', env, clear=False):
            os.environ.pop('ARES_WEBUI_AUTO_INSTALL', None)
    ...
    def test_skips_when_agent_dir_missing(self, tmp_path, capsys):
        ...
        env_overrides = {
            ...
            'ARES_HOME': str(tmp_path / 'no-ares-home'),
            'ARES_WEBUI_AUTO_INSTALL': '1',
        }
