...
import { FinanceJournalCard } from "../components/FinanceJournalCard";
            ...
            <>
              ...
              <div className="grid gap-4 xl:grid-cols-(--gtc-32)">
                ...
                <div className="space-y-4">
                  ...
                  <FinanceJournalCard rows={topFinanceEvents.slice(0, 6)} emptyMessage="No finance events yet. Add account-level charges once biller invoices or credits land." />
                </div>
              </div>
            </>
          )}
            ...
            <>
              ...
              <div className="grid gap-4 xl:grid-cols-(--gtc-33)">
                <div className="space-y-4">
                  ...
                  <FinanceJournalCard rows={topFinanceEvents} />
                </div>
