    ...
    <div className="max-w-6xl space-y-8">
      <div className="space-y-3">
        <div className="flex items-center gap-2">
          ...
          <h1 className="text-lg font-semibold">Domain Members</h1>
        </div>
        <p className="max-w-3xl text-sm text-muted-foreground">
          Manage the people who can work in {selectedDomain?.name}. Members can collaborate across the company by default.
        </p>
            ...
            <div className="space-y-5">
              <div className="grid gap-4 md:grid-cols-2">
                <label className="space-y-2 text-sm">
                  <span className="font-medium">Domain role</span>
                  <select
