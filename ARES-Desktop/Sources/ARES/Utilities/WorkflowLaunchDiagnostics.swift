...
struct WorkflowLaunchDiagnosticsContext: Sendable {
    ...
    init(
        ...
        self.hermesProfileName = connection.trimmedARESProfile
...
actor WorkflowLaunchDiagnostics {
    ...
    init(logFileURL: URL, fileManager: FileManager = .default) {
        ...
        let subsystem = Bundle.main.bundleIdentifier ?? "ARESDesktop"
        ...
        let sessionStartedLine = Self.makeLine(
            ...
            fields: [
                "banner": "=== ARES Desktop workflow launch diagnostics session started ===",
