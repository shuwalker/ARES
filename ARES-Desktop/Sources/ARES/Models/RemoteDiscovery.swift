...
struct RemoteDiscovery: Codable {
    ...
    let activeProfile: RemoteARESProfile
    let availableProfiles: [RemoteARESProfile]
    let paths: RemoteARESPaths
    let exists: RemoteARESPathExistence
...
struct RemoteARESProfile: Codable, Identifiable {
    let name: String
    let path: String
    let isDefault: Bool
    let exists: Bool
...
struct RemoteARESPaths: Codable {
    let user: String
    let memory: String
    let soul: String
...
struct RemoteARESPathExistence: Codable {
    let user: Bool
    let memory: Bool
    let soul: Bool
