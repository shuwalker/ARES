...
struct WorkflowsView: View {
    ...
    private var workflowsToolbar: some View {
        HStack(spacing: 10) {
            ARESCreateActionButton("New Workflow", help: "Create a reusable terminal workflow") {
                startCreating()
            }
        }
        .fixedSize(horizontal: true, vertical: false)
            ...
            VStack(alignment: .leading, spacing: 10) {
                HStack(alignment: .top, spacing: 10) {
                    ...
                    if missingSkills.isEmpty {
                        ARESBadge(text: "Runnable", tint: .green)
                    } else {
                        ARESBadge(text: "Missing skills", tint: .orange)
                    }
                }
            ...
            ScrollView {
                VStack(alignment: .leading, spacing: 18) {
                    ...
                    ARESSurfacePanel(
                        ...
                        subtitle: "Skills are preloaded at launch using the ARES CLI skill flags."
                    ) {
