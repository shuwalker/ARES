                    ...
                    ScrollView(.horizontal, showsIndicators: false) {
                        HStack(spacing: 8) {
                            ForEach(workspace.tabs) { tab in
                                TerminalTabChip(
                                    profileName: tab.session.connection.resolvedARESProfileName,
                    ...
                    VStack(alignment: .leading, spacing: 2) {
                        HStack(spacing: 6) {
                            ...
                            if !isCurrentWorkspace {
                                ARESBadge(text: "Other Profile", tint: .orange)
                            }
                        }
...
private struct TerminalColorMatrixPicker: View {
    ...
    var body: some View {
        ...
        .clipShape(RoundedRectangle(cornerRadius: ARESTheme.insetCornerRadius, style: .continuous))
        .overlay {
