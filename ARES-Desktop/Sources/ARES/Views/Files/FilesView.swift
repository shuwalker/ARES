...
struct FilesView: View {
    ...
    private var filesToolbar: some View {
        HStack(spacing: 10) {
            ARESCreateActionButton("Add File") {
    ...
    private var libraryPanel: some View {
        ARESSurfacePanel(
            title: "Library",
            subtitle: "Pinned ARES files and your bookmarks."
        ) {
            ScrollView {
                ...
                HStack(alignment: .top, spacing: 10) {
                    ...
                    VStack(alignment: .leading, spacing: 5) {
                        HStack(spacing: 7) {
                            ...
                            if isDirty {
                                ARESBadge(text: "Unsaved", tint: .orange)
                            }
                        }
        ...
        VStack(alignment: .leading, spacing: 14) {
            ...
            HStack(spacing: 8) {
                Button {
                    ...
                    Label(L10n.string("ARES Home"), systemImage: "house")
                }
    ...
    private var browserContent: some View {
        Group {
            if appState.isLoadingWorkspaceFileBrowser && appState.workspaceFileBrowserListing == nil {
                ARESLoadingState(label: "Loading remote files...", minHeight: 300)
