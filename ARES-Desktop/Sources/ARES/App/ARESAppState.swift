...
struct ChatBubble: Identifiable, Equatable {
    ...
    init(role: BubbleRole, content: String, timestamp: Date = Date(), references: [AttachedReference]? = nil, isStreaming: Bool = false, tokenCount: Int? = nil, latencySeconds: Double? = nil, costUSD: Double? = nil, startedAt: Date? = nil) {
        self.role = role
