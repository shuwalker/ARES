...
public struct DiscoveredTool: Identifiable, Equatable, Sendable {
    public let id: String                    // stable id, derived from name
    public let name: String                  // display name (e.g. "Claude Code")
    public let category: ToolCategory        // coding agent, model server, etc.
    public let icon: String                  // SF Symbol
    public let kind: Kind
    public let executablePath: String?       // for .cli / .binary
    public let appBundlePath: String?        // for .app
    public let webURL: String?               // for .webUI
    public let dataPath: String?             // tilde path if known
    public let lastUsed: Date?               // best-effort mtime
    ...
    public enum ToolCategory: String, Equatable, Sendable {
...
@MainActor
public final class ToolDiscovery: ObservableObject {
    public init() {}

    @Published public var tools: [DiscoveredTool] = []
