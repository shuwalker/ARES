...
public struct InstalledTool: Identifiable, Equatable, Sendable {
    public let id: String          // unique identifier, e.g. "claude-code"
    public let name: String        // display name, e.g. "Claude Code"
    public let icon: String        // SF Symbol name
    public let kind: ToolKind      // .cli or .webUI
    public let isInstalled: Bool
    public let lastUsedDate: Date? // newest mtime in the data dir, cheaply obtained
    public let hint: String?       // e.g. "CLI tool — open in Terminal"
    ...
    public let command: String?    // for .cli
    public let url: String?        // for .webUI
    public let dataPath: String?   // tilde path for the tool's data dir (Claude/Gemini etc.)
    ...
    public init(id: String, name: String, icon: String, kind: ToolKind, isInstalled: Bool, lastUsedDate: Date?, hint: String?, command: String?, url: String?, dataPath: String?) {
        self.id = id
        self.name = name
        self.icon = icon
        self.kind = kind
...
@MainActor
public final class IntegrationRegistry: ObservableObject, @unchecked Sendable {

    @Published public var installedTools: [InstalledTool] = []
    ...
    public var detected: [InstalledTool] {
