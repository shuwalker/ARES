...
public final class OdysseusSessionReader: SourceReader {

    // MARK: - SourceReader conformance

    public let sourceName = "odysseus"
    ...
    /// Initialise with an explicit database path (defaults to ~/.config/GitHub/odysseus/data/app.db).
    ...
    public func listSessions() throws -> [UnifiedSession] {
    ...
    public func loadMessages(forSessionId id: String) throws -> [SessionMessage] {
