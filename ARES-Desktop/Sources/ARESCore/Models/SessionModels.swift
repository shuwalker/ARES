...
public struct SessionListPage: Codable, Sendable {
    public let ok: Bool
...
public struct SessionSummary: Codable, Identifiable, Hashable, Sendable, TitleIdentifiable, OptionalModelDisplayable {
    public let id: String
    public let title: String?
    public let model: String?
    public let parentSessionID: String?
    public let startedAt: SessionTimestamp?
    public let lastActive: SessionTimestamp?
    public let messageCount: Int?
    public let preview: String?
    public let searchMatch: SessionSearchMatch?
...
public struct SessionSearchMatch: Codable, Hashable, Sendable {
    public let matchCount: Int
    public let messageID: String?
    public let role: SessionMessageRole?
    public let timestamp: SessionTimestamp?
...
public struct PinnedSession: Codable, Identifiable, Hashable, Sendable {
    public let id: String
    public let workspaceScopeFingerprint: String
    public var title: String?
    public var model: String?
    public var parentSessionID: String?
    public var startedAt: SessionTimestamp?
    public var lastActive: SessionTimestamp?
...
public struct SessionDetailResponse: Codable, Sendable {
    public let ok: Bool
    public let items: [SessionMessage]
}
...
public struct SessionMessageDisplay: Identifiable, Hashable, Sendable {
    public let id: String
    public let role: SessionMessageRole
    public let content: String?
    public let timestampText: String?
    public let metadataItems: [SessionMetadataDisplayItem]
    public let toolSummary: SessionToolMessageSummary?
    ...
    public init(message: SessionMessage) {
        id = message.id
        role = message.role
...
public struct SessionMetadataDisplayItem: Identifiable, Hashable, Sendable {
...
public enum SessionTimestamp: Codable, Hashable, Sendable {
...
public struct SessionToolMessageSummary: Hashable, Sendable {
    public let title: String
    public let preview: String?
    public let statusText: String?
    public let statusKind: SessionToolStatusKind
    public let sizeText: String?
    public let isDetailPreviewTruncated: Bool

    private static let jsonParseByteLimit = 256 * 1024
    private static let collapsedPreviewCharacterLimit = 220
    public static let detailPreviewCharacterLimit = 5_000
    ...
    public static func detailPreview(from content: String?) -> String? {
...
public enum SessionToolStatusKind: Hashable, Sendable {
    case success
    case failure
    case neutral
}

public enum SessionMessageRole: Codable, Hashable, Sendable {
    case assistant
    case user
    case system
    case event
...
public enum JSONValue: Codable, Hashable, Sendable {
    ...
    public var removingNulls: JSONValue? {
        switch self {
        case .null:
            return nil
        case .object(let value):
