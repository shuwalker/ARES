...
enum HermesTheme {
    ...
    // ARES accent palette
    static let aresPrimary = Color(red: 0.18, green: 0.78, blue: 0.65)     // Teal-green
    static let aresSecondary = Color(red: 0.22, green: 0.33, blue: 0.46)  // Deep navy
    static let aresAccent = Color(red: 0.96, green: 0.65, blue: 0.14)      // Warm amber
    static let aresSurface = Color(red: 0.12, green: 0.14, blue: 0.18)     // Dark surface
...
struct HermesThreeColumnSplitView<Sidebar: View, Content: View, Panel: View>: View {
    @State private var panelWidth: CGFloat = 320
    let sidebar: Sidebar
    let content: Content
    let panel: Panel
    let panelMinWidth: CGFloat
    let panelDefaultWidth: CGFloat

    init(
        panelMinWidth: CGFloat = 260,
        panelDefaultWidth: CGFloat = 320,
        @ViewBuilder sidebar: () -> Sidebar,
        @ViewBuilder content: () -> Content,
        @ViewBuilder panel: () -> Panel
    ) {
        self.panelMinWidth = panelMinWidth
        self.panelDefaultWidth = panelDefaultWidth
    ...
    var body: some View {
        GeometryReader { geometry in
            HStack(spacing: 0) {
                sidebar
                    .frame(minWidth: 160, idealWidth: 188, maxWidth: 220, maxHeight: .infinity)
                ...
                panel
                    .frame(minWidth: panelMinWidth, idealWidth: panelDefaultWidth, maxWidth: 600, minHeight: 0, maxHeight: .infinity)
            }
        }
    }
}
