        ...
        rootContent
            .toolbar {
                ...
                ToolbarItem(placement: .principal) {
                    HermesToolbarPrincipalTitle(title: "ARES")
                }
                ...
                ToolbarItemGroup(placement: .automatic) {
                    ...
                    HermesCollapseToolbarButton(
                        ...
                        isActive: appState.isDesktopPetMode,
                        isEnabled: true,
                        help: appState.isDesktopPetMode
                            ? L10n.string("Hide Desktop Pet")
                            : L10n.string("Show Desktop Pet")
                    ) {
                        appState.isDesktopPetMode.toggle()
                    }
                }
            }
